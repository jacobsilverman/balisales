...
function Post({displayUrl, item, viewCount, viewCountHeight, accountView, deletePost}) {
    ...
    return (
        <Fragment>
            ...
            <Grid item className="post-container" style={{backgroundImage: displayUrl, height: viewCountHeight+"vw"}} id={item?.id} xs={showViewCount ? 4 : 12/viewCount}>
